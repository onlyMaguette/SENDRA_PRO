...
class DepositMoneyReviewScreen extends StatelessWidget {
  const DepositMoneyReviewScreen({Key? key}) : super(key: key);
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          const Divider(),
          _rowUsdWidget(
              context, Strings.depositAmount, Strings.depositMoneyAmount),
          const Divider(),
  ...
  PrimaryButtonWidget _depositButtonWidget(BuildContext context) {
    return PrimaryButtonWidget(
      ...
      onPressed: () {
        Get.toNamed(Routes.depositMoneySuccessScreen);
      },
