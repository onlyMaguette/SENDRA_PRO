...
class WithdrawMoneySuccessScreen extends StatelessWidget {
  const WithdrawMoneySuccessScreen({Key? key}) : super(key: key);
  ...
  Column _titleWidget(BuildContext context){
    return Column(
      ...
      children: [
        ...
        Text(Strings.withdrawDescription, style: CustomStyler.otpVerificationDescriptionStyle,),
      ],
    );
  }
